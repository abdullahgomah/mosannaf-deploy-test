...
class Mosannaf(models.Model):
    name = models.CharField(max_length=255, verbose_name='اسم المصنف', unique=True)
    ...
    def save(self, *args, **kwargs):
        ...
        super(Mosannaf, self).save(*args, **kwargs)
...
class TranslatedMosannaf(models.Model):
    ...
    # 12# الناشر
    publisher = models.ForeignKey(
        "publisher.Publisher", on_delete=models.SET_NULL, null=True, blank=True, verbose_name="الناشر")
